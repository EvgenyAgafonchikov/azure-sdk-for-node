 ...
 *
 * @member {string} [radiusServer] The radius server address property of the
 * VirtualNetworkGateway resource for vpn client connection.
 *
 * @member {string} [radiusSecret] The radius secret property of the
 * VirtualNetworkGateway resource for vpn client connection.
 *
 ...
 *
 * @member {string} [virtualNetworkGateway1.radiusServer] The radius server
 * address property of the VirtualNetworkGateway resource for vpn client
 * connection.
 *
 * @member {string} [virtualNetworkGateway1.radiusSecret] The radius secret
 ...
 * added to routes learned from this BGP speaker.
 *
 * @member {string} [virtualNetworkGateway2.radiusServer] The radius server
 * address property of the VirtualNetworkGateway resource for vpn client
 * connection.
 *
 * @member {string} [virtualNetworkGateway2.radiusSecret] The radius secret
 * property of the VirtualNetworkGateway resource for vpn client connection.
 *
